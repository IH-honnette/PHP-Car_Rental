            ...
            <div class="contact-info-form">
                ...
                <?php foreach ($cars as $car) : ?>
                    ...
                    <div class="social-input-containers">
                        <input type="text" name="name" class="input" placeholder="Name" value="<?= set_value('name', $car->name) ?>" />
                        <?= form_error('name') ?>
                    </div>
                    <div class="social-input-containers">
                        <input type="text" name="model" class="input" placeholder="Model" value="<?= set_value('model', $car->model) ?>" />
                        <?= form_error('model') ?>
                    </div>
                    <div class="social-input-containers">
                        <input type="text" pattern="[1-9]+" title="from 1 seat and above" name="seats" class="input" placeholder="Seats" value="<?= set_value('seats', $car->seats) ?>" />
                        <?= form_error('seats') ?>
                    </div>
                    <div class="social-input-containers">
                        <input type="text" name="price" class="input" placeholder="Hireprice" value="<?= set_value('price', $car->price) ?>" />
                        <?= form_error('price') ?>
                    </div>
                    <div class="social-input-containers">

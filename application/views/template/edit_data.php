    ...
    <div class="form">
        ...
        <span class="circle one"></span> <span class="circle two"></span>
            ...
            <form action="<?=base_url('MyApp/edit_record/').$user->userId;?>"  autocomplete="off" method="post">
                ...
                <div class="social-input-containers"> 
                <input type="email" name="email" class="input" placeholder="Email" value="<?= set_value('email',$user->email)?>"  />
                <?= form_error('email')?>
                 </div>
                <div class="social-input-containers"> 
                <input type="tel" name="phone" class="input" placeholder="Phone" value="<?= set_value('phone',$user->phone)?>"  />
                <?= form_error('phone')?>
                </div>
                <div class="social-input-containers"> 
